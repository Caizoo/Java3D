...
public class Entity {
	...
	private float scale;
	private boolean useBackCulling = true;
	...
	public Entity(TexturedModel model, Vector3f position, float rotX, float rotY, float rotZ, float scale, boolean backCulling) {
		super();
		this.model = model;
		this.position = position;
		this.rotX = rotX;
		...
		this.rotZ = rotZ;
		this.scale = scale;
		this.useBackCulling = backCulling;
	}
	...
	public boolean getBackCulling() { return useBackCulling; }
